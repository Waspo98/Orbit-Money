...
- **Settings page:** Collapsible/reorderable cards for Appearance, Turn App Features On/Off, SimpleFIN, Rocket Money CSV import, Account, and Orbit Money build details. The feature toggle card owns frontend-only navigation visibility, More-card order, and the existing MHA visibility control.
