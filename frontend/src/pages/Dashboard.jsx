...
const DASHBOARD_DEPTH_PATTERN_WIDTH = 720;
const DASHBOARD_DEPTH_PATTERN_HEIGHT = 520;
const DASHBOARD_DEPTH_PATTERN = createDashboardDepthPattern();
...
function createDashboardDepthPattern() {
  ...
  const extraStars = Array.from({ length: 8 }, () => ({
    x: formatMeshNumber(randomBetween(24, DASHBOARD_DEPTH_PATTERN_WIDTH - 24)),
    y: formatMeshNumber(randomBetween(28, DASHBOARD_DEPTH_PATTERN_HEIGHT - 28)),
...
function DashboardDepthPattern() {
  const { primary, secondary, stars } = DASHBOARD_DEPTH_PATTERN;
      ...
      <svg focusable="false" role="presentation">
        <defs>
          <pattern
            ...
            width={DASHBOARD_DEPTH_PATTERN_WIDTH}
            height={DASHBOARD_DEPTH_PATTERN_HEIGHT}
